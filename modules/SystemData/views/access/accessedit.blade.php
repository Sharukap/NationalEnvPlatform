...
@section('cont')
<kbd><a href="/sytem-data/accessindex" class="text-white font-weight-bolder"><i class="fas fa-chevron-left"></i></i> BACK</a></kbd>
<div class="container">
 ...
 <form method="post" action="/sytem-data/accessupdate/{{$access->id}}">
                 @csrf
                @method('patch')
