...
<kbd><a href="/environment/viewdata" class="text-white font-weight-bolder"><i class="fas fa-chevron-left"></i></i> BACK</a></kbd>
        ...
        <div class="col-6 ml-3">
            <form enctype="multipart/form-data">
                <div class="input-group mb-3">
                    ...
                    <input type="integer" class="form-control" placeholder="{{ $ecosystems->created_by_user_id}}" readonly>
                </div>

                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <span class="input-group-text">Eco-System Type</span>
                    </div>
