...
<div class="container">
    <div class="row p-4 bg-white">
        <div class="col border border-muted rounded-lg mr-2 p-4">
            <h3>{{$process_item->form_type->type}} Application No {{$process_item->form_id}}</h3>  
            <h3 style="color:red; text-align:center">{{$process_item->status->type}}</h3>
            <h5>Reference No {{$process_item->id}}</h4>
        </div>
    </div>
    <div class="row p-4 bg-white">
        <div class="col border border-muted rounded-lg mr-2 p-4">
            ...
            <li>{{$process_item->status->type}} by Mr/Mrs. {{$user->name}}, {{$user->designation->designation}} at {{$user->organization->title}}</li>
            <li>Reason: {{$remark}}</li>
            </ul>
        </div>
    </div>
    ...
    <div class="row p-4 bg-white">
        <div class="col border border-muted rounded-lg mr-2 p-4">
                <h5>This is a system generated document.</h5>
        </div>
    </div>
    <div class="row p-4 bg-white">
        <div class="col border border-muted rounded-lg mr-2 p-4">
